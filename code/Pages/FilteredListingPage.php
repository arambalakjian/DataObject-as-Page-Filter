...
JS
     ...
     */
    public function getFilterOptionSet($FilterTitle, $VarName, $OptionObjects, $MultiSelect = true, $TitleField = 'Title', $KeyField = 'ID')
    {
        ...
        foreach ($OptionObjects as $Object) {
            ...
            if ($MultiSelect && $CurrentValues = $this->getFilterValue($VarName)) {
                ...
                //If none are selected we can just return the current value
     ...
     */
    public function getOptionLinkingMode($Object, $VarName, $KeyField = 'ID')
    {
    ...
    public function getCurrentFilterString($Exclude = null, $Symbol = '&', $ExcludePagination = true)
    {
        if (!is_array($Exclude)) {
